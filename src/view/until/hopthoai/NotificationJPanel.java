...
public class NotificationJPanel extends javax.swing.JComponent {

    private JDialog dialog;
    private Animator animator;
    private final JPanel fram;
    ...
    public NotificationJPanel(JPanel fram, Type type, Location location, String message) {
        this.fram = fram;
        this.type = type;
