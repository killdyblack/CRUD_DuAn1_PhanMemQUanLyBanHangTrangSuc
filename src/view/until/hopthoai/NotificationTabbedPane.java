...
public class NotificationTabbedPane extends javax.swing.JComponent {

    private JDialog dialog;
    private Animator animator;
    private final JTabbedPane fram;
    ...
    public NotificationTabbedPane(JTabbedPane fram, Type type, Location location, String message) {
        this.fram = fram;
        this.type = type;
    ...
    private void init(String message) {
        ...
        if (type == Type.SUCCESS) {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/until/hopthoai/sucess.png")));
            ...
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/until/hopthoai/warning.png")));
    ...
    private void initComponents() {
        ...
        lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/until/hopthoai/sucess.png"))); // NOI18N
        ...
        panelLayout.setVerticalGroup(
            ...
            .addGroup(panelLayout.createSequentialGroup()
                ...
                .addComponent(lbMessage)
                .addGap(3, 3, 3)
                .addComponent(lbMessageText, javax.swing.GroupLayout.DEFAULT_SIZE, 27, Short.MAX_VALUE)
                .addContainerGap())
        );

        cmdClose.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/until/hopthoai/close.png"))); // NOI18N
