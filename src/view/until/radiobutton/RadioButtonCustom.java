package view.until.radiobutton;
...
public class RadioButtonCustom extends JRadioButton {
    ...
    public void paint(Graphics grphcs) {
        ...
        if (isSelected()) {
            if (isEnabled()) {
                g2.setColor(getBackground()); // Blue color when selected and enabled
            } else {
                g2.setColor(Color.GRAY);
            }
            g2.fillOval(1, ly, 16, 16);
            ...
            if (isEnabled()) {
                g2.setColor(getBackground()); // Blue color for the inner circle when selected and enabled
            } else {
                g2.setColor(Color.GRAY);
            }
